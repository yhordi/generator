const libraries = {
  name: [
    ['To', 'Be', 'Jo', 'Am', 'Da', 'Wo', 'El', 'Al', 'Pa', 'Ra', 'Xa', 'Re', 'Wa', 'Uk', 'Og', 'Po', 'Di', 'Fi', 'Iz', 'Zo'],
    ['re', 'orn', 'bi', 'shi', 'ru', 'ha', 'da', 'he', 'la', 'x', 'jo', '', 'han', 'ga', 'no', 'vi', 'le', 'qi', 'ex', 's', 'bb', 'cc', 'k', 'ck', 'ia'],
    ['lan', 'tar', 'rf', 'shi', 'ji', 'ro', 'en', 'an', 'do', 'ti', '', 'dyn', 'wyn', 'ia', 'sha', 'ko', 'ka', 'ki', 'ta', 'nil', 'lil', 'yn', 'ugh', 'gh', 'ach', 'et', 'ar', 'lin', 'lyn', 'on', 'am', 's', 'han', 'had', 'has' ]
  ],
  epicName: [
